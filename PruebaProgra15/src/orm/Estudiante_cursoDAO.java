...
public class Estudiante_cursoDAO {
	...
	public static boolean save(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().saveObject(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().deleteObject(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Estudiante_curso estudiante_curso)throws PersistentException {
		try {
			...
			orm.Mensualidad[] lMensualidads = estudiante_curso.mensualidad.toArray();
			for(int i = 0; i < lMensualidads.length; i++) {
				lMensualidads[i].setEstudiante_curso(null);
			}
	...
	public static boolean refresh(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().refresh(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Estudiante_curso estudiante_curso) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().evict(estudiante_curso);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
