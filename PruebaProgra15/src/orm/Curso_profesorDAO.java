...
public class Curso_profesorDAO {
	...
	public static boolean save(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().saveObject(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().deleteObject(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Curso_profesor curso_profesor)throws PersistentException {
		try {
			...
			orm.Sueldo[] lSueldos = curso_profesor.sueldo.toArray();
			for(int i = 0; i < lSueldos.length; i++) {
				lSueldos[i].setCurso_profesor(null);
			}
	...
	public static boolean refresh(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().refresh(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Curso_profesor curso_profesor) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().evict(curso_profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
