...
public class MensualidadDAO {
	...
	public static boolean save(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().saveObject(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().deleteObject(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Mensualidad mensualidad)throws PersistentException {
		try {
			...
			if(mensualidad.getEstudiante_curso() != null) {
				mensualidad.getEstudiante_curso().mensualidad.remove(mensualidad);
			}
	...
	public static boolean refresh(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().refresh(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Mensualidad mensualidad) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().evict(mensualidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
