...
public class JefeadministracionDAO {
	...
	public static boolean save(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().saveObject(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().deleteObject(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().refresh(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Jefeadministracion jefeadministracion) throws PersistentException {
		try {
			orm.DiagramaetpmPersistentManager.instance().getSession().evict(jefeadministracion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
