...
import org.orm.*;
public class ListDiagramaetpmData {
	...
	public static void main(String[] args) {
		try {
			ListDiagramaetpmData listDiagramaetpmData = new ListDiagramaetpmData();
			try {
				listDiagramaetpmData.listTestData();
				//listDiagramaetpmData.listByCriteria();
			}
			finally {
